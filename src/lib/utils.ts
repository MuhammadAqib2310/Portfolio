...
export const projects = [
  ...
  },
  {
    ...
    title: "Apex AI",
    category: "AI",
    description: "Full-featured AI assistant platform with multi-model support, intelligent conversations, code generation, and document analysis.",
    image: "/projects/apex.jpg",
    features: ["Multi-Model AI", "Code Generation", "Document Analysis", "Conversation Memory"],
    tech: ["JavaScript", "OpenAI", "Node.js", "React", "MongoDB"],
    demo: "https://apex-ai-seven.vercel.app",
    github: "https://github.com/MuhammadAqib2310/apex-ai",
    metrics: { score: "96/100", type: "AI Platform", status: "Live ✓" },
  },
  {
    id: 6,
    title: "Lead Generation System",
    category: "SaaS",
    description: "Intelligent lead capture and nurturing platform with automated outreach, CRM integration, and AI-powered lead scoring.",
    image: "/projects/lead.jpg",
    features: ["AI Lead Scoring", "Automated Outreach", "CRM Integration", "Analytics Dashboard"],
  ...
  },
  {
    ...
    title: "Qanoon Bridge",
    category: "AI",
    description: "AI-powered legal assistance platform that bridges the gap between citizens and Pakistani law through intelligent Q&A and document analysis.",
    image: "/projects/qanoon.jpg",
    features: ["Legal Q&A AI", "Document Analysis", "Case Research", "Urdu/English Support"],
    tech: ["Python", "LangChain", "OpenAI", "FastAPI", "Next.js"],
    demo: "https://github.com/MuhammadAqib2310",
    github: "https://github.com/MuhammadAqib2310",
    metrics: { score: "97/100", type: "Legal AI", status: "Built ✓" },
  },
  {
    id: 8,
    title: "PhytoPathometric App",
    category: "AI",
    description: "Plant disease detection and analysis app using computer vision and deep learning to identify crop diseases from images with treatment recommendations.",
    image: "/projects/phyto.jpg",
    features: ["Disease Detection", "Computer Vision", "Treatment Advice", "Crop Analytics"],
    tech: ["Python", "TensorFlow", "FastAPI", "React", "OpenCV"],
    demo: "https://github.com/MuhammadAqib2310",
    github: "https://github.com/MuhammadAqib2310",

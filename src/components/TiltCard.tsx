  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: hovered
          ? "0 8px 48px rgba(232,121,160,0.22), 0 2px 16px rgba(252,165,192,0.12), 0 0 0 1px rgba(252,165,192,0.25)"
          : "0 4px 24px rgba(0,0,0,0.25), 0 0 0 1px rgba(255,255,255,0.06)",
        border: hovered
          ? "1px solid rgba(252,165,192,0.3)"
    ...
    >
      ...
      <div
        style={{
          ...
          right: "10%",
          height: "1px",
          background: "linear-gradient(90deg, transparent, rgba(252,165,192,0.6), transparent)",
          pointerEvents: "none",
          zIndex: 3,
          opacity: hovered ? 1 : 0,

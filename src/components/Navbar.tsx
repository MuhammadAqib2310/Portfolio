  ...
  return (
    <>
      ...
      <motion.div
        ...
        style={{
          background: "linear-gradient(90deg, #FFFFFF 0%, #E2E2E2 50%, #A0A0A0 100%)",
          scaleX,
        }}
      />
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col leading-none">
              ...
              >
                M<span style={{ color: "#FFFFFF" }}>.</span>Aqib
              </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              style={{
                background: open ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.06)",

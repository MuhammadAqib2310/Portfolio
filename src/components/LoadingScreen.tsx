    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, #080808 0%, #111111 60%, #0D0D0D 100%)" }}
        >
          {/* Orbs */}
          <div className="absolute pointer-events-none rounded-full"
            style={{ width: 400, height: 400, top: "15%", left: "10%",
              background: "radial-gradient(circle, rgba(255,255,255,0.2), transparent 65%)", filter: "blur(60px)" }} />
          <div className="absolute pointer-events-none rounded-full"
            style={{ width: 350, height: 350, bottom: "10%", right: "10%",
              background: "radial-gradient(circle, rgba(226,226,226,0.15), transparent 65%)", filter: "blur(60px)" }} />
          ...
          >
            ...
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, #FFFFFF, #E2E2E2)",
            ...
            <AnimatePresence mode="wait">
              <motion.p
                ...
                style={{ fontSize: "0.72rem", letterSpacing: "0.25em", fontWeight: 700,
                  textTransform: "uppercase", color: "#FFFFFF", marginTop: "0.5rem" }}
              >
          ...
          <div style={{ width: "clamp(160px, 30vw, 240px)" }}>
            <div className="relative h-[2px] rounded-full overflow-hidden mb-3"
              ...
              <motion.div
                ...
                style={{ background: "linear-gradient(90deg, #FFFFFF, #E2E2E2)",

    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, #0A0A0F 0%, #141420 60%, #0F0F1A 100%)" }}
        >
          {/* Orbs */}
          <div className="absolute pointer-events-none rounded-full"
            style={{ width: 400, height: 400, top: "15%", left: "10%",
              background: "radial-gradient(circle, rgba(212,175,55,0.2), transparent 65%)", filter: "blur(60px)" }} />
          <div className="absolute pointer-events-none rounded-full"
            style={{ width: 350, height: 350, bottom: "10%", right: "10%",
              background: "radial-gradient(circle, rgba(247,231,206,0.15), transparent 65%)", filter: "blur(60px)" }} />
            ...
            <AnimatePresence mode="wait">
              <motion.p
                ...
                style={{ fontSize: "0.72rem", letterSpacing: "0.25em", fontWeight: 700,
                  textTransform: "uppercase", color: "#D4AF37", marginTop: "0.5rem" }}
              >
          ...
          <div style={{ width: "clamp(160px, 30vw, 240px)" }}>
            <div className="relative h-[2px] rounded-full overflow-hidden mb-3"
              ...
              <motion.div
                ...
                style={{ background: "linear-gradient(90deg, #D4AF37, #F7E7CE)",
            ...
            <div className="flex justify-between items-center">
              ...
              <span style={{ fontSize: "0.7rem", fontWeight: 800, color: "#D4AF37" }}>

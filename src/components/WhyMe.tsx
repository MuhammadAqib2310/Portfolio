    ...
    >
      ...
      <div className="absolute pointer-events-none rounded-full"
        style={{ width: 500, height: 500, top: 0, right: "-10%",
          background: "radial-gradient(circle, rgba(124,111,255,0.08), transparent 65%)", filter: "blur(80px)" }} />
      <div className="absolute pointer-events-none rounded-full"
        style={{ width: 400, height: 400, bottom: 0, left: "-8%",
          background: "radial-gradient(circle, rgba(0,229,255,0.06), transparent 65%)", filter: "blur(70px)" }} />
      ...
      <div className="wrap">
        ...
        >
          <span className="sec-label" style={{ color: "#00E5FF" }}>Why Work With Me</span>
        ...
        >
          {stats.map(({ end, suffix, label }) => (
            <div
              ...
              style={{ padding: "1.5rem 1rem", background: "rgba(124,111,255,0.06)",
            ...
            >
              ...
              <div style={{ fontSize: "0.7rem", color: "#6B7096", marginTop: "0.4rem", fontWeight: 600, letterSpacing: "0.05em" }}>
                {label}
              </div>
            </div>
          ))}
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed" style={{ color: "#6B7096" }}>{r.desc}</p>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          style={{ padding: "2.5rem", background: "linear-gradient(135deg, rgba(124,111,255,0.15), rgba(0,229,255,0.08))",
            border: "1px solid rgba(124,111,255,0.25)" }}
        >
          {/* BG glow */}
          <div className="absolute inset-0 pointer-events-none"
            style={{ background: "radial-gradient(ellipse at 30% 50%, rgba(124,111,255,0.12), transparent 60%)" }} />
          ...
          <div className="relative flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm" style={{ color: "#6B7096" }}>
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: "0 0 32px rgba(124,111,255,0.5)" }}
                whileTap={{ scale: 0.97 }}

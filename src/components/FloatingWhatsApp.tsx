...
export default function FloatingWhatsApp() {
  ...
  const open = () => {
    window.open(
      `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi Aqib! I visited your portfolio and I'd like to discuss a project.")}`,
      "_blank"
    );
  };
        ...
        >
          ...
          <motion.button
            ...
            style={{
              ...
              animation: "waRipple 2s ease-in-out infinite",
            }}

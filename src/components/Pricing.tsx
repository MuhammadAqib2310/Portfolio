...
export default function Pricing() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg, #111111 0%, #080808 100%)" }}
    >
      {/* BG glows */}
      ...
      <div className="wrap">
        ...
        >
          <span className="sec-label" style={{ color: "#A0A0A0" }}>Investment</span>
            ...
            >
              ...
              >
                ...
                <motion.button
                  ...
                  style={{
                    padding: "0.875rem",
                    background: plan.popular ? `linear-gradient(135deg, #FFFFFF, #E2E2E2)` : `${plan.color}18`,
